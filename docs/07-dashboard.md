...
- Targetings: Count Query on `targetings` table with user_id filter
- Goodreads: Count Query on `goodreads` table with user_id filter
...
**Actions to define:**
- "New Idea" → /ideas/new
- "New Targeting" → /targetings/new
- "New Goodread" → /goodreads/new
