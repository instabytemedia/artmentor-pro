...
**Description:** AI-powered mentorship and blockchain-based portfolio management
...
- **title:** Object with default and template
  ...
  - template: "%s | ArtMentor Pro" (for page-specific titles)
...
- **authors:** [{ name: "ArtMentor Pro" }]

- **creator:** "ArtMentor Pro"
...
- "/" → "ArtMentor Pro"
- "/login" → "Sign In | ArtMentor Pro"
- "/signup" → "Sign Up | ArtMentor Pro"
- "/dashboard" → "Dashboard | ArtMentor Pro"
